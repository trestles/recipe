...
{
    [super viewDidLoad];
    NSLog(@"here is count %i", self.recipes.count );
...
{
    NSLog(@"clicked at: %i", indexPath.row);
    ...
    //detailVC.recipe=[self.recipes objectAtIndex:indexPath.row];
    //recipeAtIndex.indexPath.row];
